  ...
  <div class="container-fluid">
    ...
    <main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">Search Customers by Clues</li>
      </ol>
    </nav>
      ...
      <script type="text/javascript">
        $(document).ready(function() {
          ...
          $("#sell").change(function() {
            ...
            if(el.val() === "Order No" ) {
            $("#status").append("  <input type="text" name="customername" class="form-control" id="customername" placeholder="" value="<?php echo($customername);?>">");
          }
...
<div>
    <div class="form-group row">
      ...
      <div class="col-sm-4">
        <input type="text" name="customername" class="form-control" id="customername" placeholder="" value="<?php echo($customername);?>">
            </div>
         <?php 
         ?>
    ...
    <div class="form-group row">
      ...
      <div class="col-sm-4">
        <input type="text" name="sorder_no" class="form-control" id="sorder_no" placeholder="" value="<?php echo($sorder_no);?>">
  ...
  <div class="form-group row">
   ...
   <div class="form-group row">
      <label for="inputPassword3" class="col-sm-2 col-form-label"><strong>Customer Address</strong></label>
      <div class="col-sm-4">
  ...
  <div class="form-group row">
    ...
    <tr>
      ...
      <?php
          ...
          {
            $info=getData();
              $search_query="SELECT c.customerid,c.customername,c.contactno,c.address,c.distance,c.location,so.order_name,so.date,sol.quantity,so.sorder_no FROM customers c INNER JOIN salesorders so ON c.customerid = so.customerid INNER JOIN salesorderlines sol ON so.sorder_no=sol.sorder_no WHERE sol.quantity='$info[7]'";
    ...
    <tr>
      ...
      <?php
          ...
          {
            $info=getData();
              $search_query="SELECT c.customerid,c.customername,c.contactno,c.address,c.distance,c.location,so.order_name,so.date,sol.quantity,so.sorder_no FROM customers c INNER JOIN salesorders so ON c.customerid = so.customerid INNER JOIN salesorderlines sol ON so.sorder_no=sol.sorder_no WHERE so.date='$info[6]'";
    ...
    <tr>
      ...
      <?php
          ...
          {
            $info=getData();
              $search_query="SELECT c.customerid,c.customername,c.contactno,c.address,c.distance,c.location,so.order_name,so.date,sol.quantity,so.sorder_no FROM customers c INNER JOIN salesorders so ON c.customerid = so.customerid INNER JOIN salesorderlines sol ON so.sorder_no=sol.sorder_no WHERE so.order_name='$info[5]'";
    ...
    <tr>
      ...
      <?php
          ...
          {
            $info=getData();
              $search_query="SELECT c.customerid,c.customername,c.contactno,c.address,c.distance,c.location,so.order_name,so.date,sol.quantity,so.sorder_no FROM customers c INNER JOIN salesorders so ON c.customerid = so.customerid INNER JOIN salesorderlines sol ON so.sorder_no=sol.sorder_no WHERE c.address='$info[4]'";
    ...
    <tr>
      ...
      <?php
          ...
          {
            $info=getData();
              $search_query="SELECT c.customerid,c.customername,c.contactno,c.address,c.distance,c.location,so.order_name,so.date,sol.quantity,so.sorder_no FROM customers c INNER JOIN salesorders so ON c.customerid = so.customerid INNER JOIN salesorderlines sol ON so.sorder_no=sol.sorder_no INNER JOIN items it ON sol.item_no=it.item_no WHERE it.item_name='$info[3]'";
  ...
  <?php
    ...
    <tr>
      ...
      <?php
          ...
          {
            $info=getData();
              $search_query="SELECT c.customerid,c.customername,c.contactno,c.address,c.distance,c.location,so.order_name,so.date,sol.quantity,so.sorder_no FROM customers c INNER JOIN salesorders so ON c.customerid = so.customerid INNER JOIN salesorderlines sol ON so.sorder_no=sol.sorder_no WHERE c.contactno='$info[2]' ORDER BY date DESC LIMIT 1 OFFSET 1";
    ...
    <tr>
      ...
      <?php
          ...
          {
            $info=getData();
              $search_query="SELECT c.customerid,c.customername,c.contactno,c.address,c.distance,c.location,so.order_name,so.date,sol.quantity,so.sorder_no FROM customers c INNER JOIN salesorders so ON c.customerid = so.customerid INNER JOIN salesorderlines sol ON so.sorder_no=sol.sorder_no WHERE c.customername='$info[1]'";
    ...
    <div class="table-responsive" style="overflow-y: auto;height: 250px">
      ...
      <!-- <style>
        body {
          ...
          //search
          if(isset($_POST['sorder_no']))
          {
            $info=getData();
              $search_query="SELECT c.customerid,c.customername,c.contactno,c.address,c.distance,c.location,so.order_name,so.date,sol.quantity,so.sorder_no FROM customers c INNER JOIN salesorders so ON c.customerid = so.customerid
                INNER JOIN salesorderlines sol  ON so.sorder_no=sol.sorder_no WHERE so.sorder_no = '$info[0]'";

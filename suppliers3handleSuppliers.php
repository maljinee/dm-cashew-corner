...
<html lang="en">
  ...
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active" aria-current="page">Handle Supplier Details</li>
  </ol>
</nav>
  ...
  <form onreset="cleartheform()" class="border-class" id="myForm" method="post" action="suppliers3handleSuppliers.php">
  ...
  <div class="form-group row">
    <label for="inputEmail3" class="col-sm-2 col-form-label"><strong>Supplier Id</strong></label>
    <div class="col-sm-5">
      <input type="number" name="supplierid" onkeyup="searchbyId()" class="form-control" id="supplierid" placeholder="" value="<?php echo($supplierid);?>">
    </div>
 <!--  <script type="text/javascript">
...
<div class="btn-group col-sm-4">
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-5">
      <input type="text" name="suppliername"  onkeyup="searchbyName()" class="form-control" id="suppliername" placeholder="" onkeypress="show1();show2();" value="<?php echo($suppliername);?>">
    </div>
...
if($link === false){
 ...
 $sql="SELECT 
          s.supplierid,s.suppliername,s.contactno,s.address,s.distance,s.location FROM
...
<script type="text/javascript">
  ...
  for(var i=1; i < table.rows.length; i++)
  {
    table.rows[i].onclick = function()
    {
      ...
      // console.log(rIndex);
      document.getElementById("supplierid").value=this.cells[0].innerHTML;
